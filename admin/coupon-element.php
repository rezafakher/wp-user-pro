    ...
    public static function add_coupon_elements( $obj ) {
        ...
        <table class="form-table" style="width: 100%">
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" class="wpuf-date-picker" placeholder="<?php _e( 'Start date', 'wpuf-pro' ); ?>" size="25" id="" value="<?php echo wpuf_get_date( $start_date, false ); ?>" name="start_date" />
                    <input type="text" class="wpuf-date-picker" placeholder="<?php _e( 'End date', 'wpuf-pro' ); ?>" size="25" id="" value="<?php echo wpuf_get_date( $end_date, false ); ?>" name="end_date" />
